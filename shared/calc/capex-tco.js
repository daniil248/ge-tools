// =============================================================================
// shared/calc/capex-tco.js — CAPEX / OPEX / TCO / NPV / payback
// =============================================================================
// Pure-функции экономической модели подбора оборудования. Универсальный
// модуль для технико-экономического сравнения вариантов в ЛЮБОМ
// конфигураторе (подбор холода, ИБП, АКБ, …). v0.60.427: вынесен из
// cooling/calc/ в shared/calc/ без изменения логики — для переиспользования
// в ups-config и battery (подбор=условия, варианты=решения, TCO/CAPEX/OPEX).
//
