...
> **Статус:** v0.60.667 (2026-05-17). Редизайн модуля отчётов
> (X.6.3) **завершён**: единый flow-документ (наложение устранено,
> verified e2e), редактор на flow (WYSIWYG=PDF), правка из превью,
> комплектные сиды, общий конвейер `composeReport` — ВСЕ отчёты
> проекта на pickTemplate+flow+previewPDF; R6 (чистка legacy) опц.
> Архитектурная
