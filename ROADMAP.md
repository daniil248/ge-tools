...
> **Статус:** v0.60.529 (2026-05-16). Текущий приоритет — **архитектурная
...
> **реестр полон — modules.json v1.3.0, 28 UI + 1 calc-lib**
> (UNREGISTERED 0, PARITY 0; все +13 ui = free, нулевой риск).
