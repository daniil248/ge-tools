...
> **Статус:** v0.60.533 (2026-05-16). Текущий приоритет — **архитектурная
...
- [~] X.1.4 Структура-канон + calc/ui-нормализация. memory:module_separation
  ...
  `ups-config/calc/ups-sizing.js` ✅ (v0.60.533, parseRedundancy/
  calcModules). Осталось по 1 модулю: rack-config (2.7k),
  scs-config/scs-design (~5.2k), tech-workspace (5.7k).
