...
> **Статус:** v0.60.687 (2026-05-17). Модуль отчётов (X.6.3)
...
> DOCX), вкладка «Разделы» (наглядный список разделов с
> посекционными настройками), legacy absolute-overlay убран.
> Verified e2e. Архитектурная
