...
> Переезд репо `daniil248/raschet`→`daniil248/ge-tools` (slug решён)
> ОТЛОЖЕН — нет доступа к Settings; URL-литералы пока на `/raschet/`,
> чек-лист в RENAME.md «Переезд репозитория (отложен)».
>
> **Статус:** v0.60.745 (2026-05-18). Платформа + предметные модули.
