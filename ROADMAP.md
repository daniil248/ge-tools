...
> **Статус:** v0.60.561 (2026-05-17). Текущий приоритет — **архитектурная
...
- [~] **1.7** Все отчёты только через `reports/` (blocks API).
  ...
  `battery/battery-calc.js:3787`, `logistics/logistics.js:222`,
  `pdu-config/pdu-config.js:637`, `ups-config/ups-config.js:2221`
  — мигрировать в blocks[] по одному (визуальный diff-парность).
