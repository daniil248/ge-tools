...
> Репозиторий переезжает `daniil248/raschet`→`daniil248/ge-tools`
> (live-URL `…github.io/ge-tools/`; рейнейм репо на GitHub — действие
> владельца, код-side готов).
>
> **Статус:** v0.60.744 (2026-05-18). Платформа + предметные модули.
