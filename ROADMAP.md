...
> **Статус:** v0.60.563 (2026-05-17). Текущий приоритет — **архитектурная
...
- [~] **1.7** Все отчёты только через `reports/` (blocks API).
  ...
  pdu-config ✅ (v0.60.562), logistics ✅ (v0.60.563); осталось
  `battery/battery-calc.js:3787`, `ups-config/ups-config.js:2221`
  — по одному (визуальный diff-парность).
