...
> **Статус:** v0.60.722 (2026-05-18). Спека архитектуры Конструктор+
> дисциплины+специалисты (X.4.5.3, Вариант I) — shared/contracts/
> schema-constructor-architecture.md. Модуль отчётов (X.6.3)
