...
- [ ] **1.1** Контракт-доки: `shared/contracts/README.md`,
  ...
  `CONTRIBUTING.md`, `lint-allowlist.json`. *(этот деливери — спека готова)*
- [ ] **1.2** `tools/boundary-lint.mjs` + `tools/gen-modules-json.mjs` +
  CI `.github/workflows/contracts.yml` (не-блок→блок). `arch:Фаза 7,43`
