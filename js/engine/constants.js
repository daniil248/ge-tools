...
export const APP_VERSION = '0.59.653';
...
export const GLOBAL = {
  ...
  // v0.59.653: метод расчёта максимума нагрузки на щитах/источниках.
  // 'linear' — простая сумма (текущий метод, без изменений).
  // 'rtm' — РТМ 36.18.32.4-92 «упорядоченные диаграммы» с автоматическим
  // применением Ки и Кмакс (одновременности). Для подбора оборудования
  // под Tier-сертификацию Uptime Institute и подачу заявки на ТУ.
  // n._rtmMax всегда вычисляется в обоих режимах (доступно для отчётов).
  calcMaxMethod: 'linear',  // 'linear' | 'rtm'
